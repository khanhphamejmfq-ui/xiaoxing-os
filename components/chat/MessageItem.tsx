...
const MessageItem = React.memo(({
        ...
        return commonLayout(
            <div className="w-64 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl p-4 text-white shadow-lg relative overflow-hidden group active:scale-[0.98] transition-transform">
                    ...
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="font-medium text-white/90">星星币</span>
                    </div>
    ...
    return commonLayout(
        <div className={isVoiceOnlyMsg
            ...
            : `relative ${bubbleVariant === 'flat' || bubbleVariant === 'outline' || bubbleVariant === 'wechat' ? '' : 'shadow-sm '}px-5 py-3 animate-fade-in ${bubbleVariant === 'outline' ? '' : 'border border-black/5 '}active:scale-[0.98] transition-transform overflow-visible ${isUser ? 'xiaoxing-bubble-user' : 'xiaoxing-bubble-ai'}`}
